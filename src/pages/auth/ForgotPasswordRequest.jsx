...
export default function ForgotPasswordRequest() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ⏳ Wait 2 seconds to let user read message, then navigate
      setTimeout(() => {
  ...
  return (
    <div>
      ...
      <div className="flex justify-center items-center py-20 bg-gray-100">
        <div className="w-full max-w-md bg-white md:p-8 p-4 mx-2 md:mx-0 rounded-lg shadow-xl animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* ✅ Render success message inline before navigating */}
            {successMessage && (
      ...
      {/* ❌ Error Modal (only shows if failed) */}
